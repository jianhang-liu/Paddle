...
void OperatorWithKernel::RunImpl(const Scope& scope,
  ...
  if (!kernel_type_) {
    ChooseKernel(*runtime_ctx_, scope, place);
  }
  ...
  auto* transfer_scope =
      PrepareData(scope, *kernel_type_, &transfered_inplace_vars, runtime_ctx_.get());
  ...
  (*kernel_func_)(
      ExecutionContext(*this, exec_scope, *dev_ctx, *runtime_ctx_, kernel_configs));
